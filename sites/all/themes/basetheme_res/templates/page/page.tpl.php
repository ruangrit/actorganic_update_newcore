...
<head>
  ...
  <?php print $styles; ?>
   <link rel="stylesheet" type="text/css" href="/<?php print path_to_theme(); ?>/css/device-smartphone.css" media="only all and (max-width: 480px)" id="stylesheet-480" />
   <link rel="stylesheet" type="text/css" href="/<?php print path_to_theme(); ?>/css/device-tablets.css" media="only all and (min-width: 480px) and (max-width: 768px)" id="stylesheet-768" />  
   <link rel="stylesheet" type="text/css" href="/<?php print path_to_theme(); ?>/css/device-desktop.css" media="only all and (min-width: 768px) and (max-width: 1024px)" id="stylesheet-1024" />
   <link rel="stylesheet" type="text/css" href="/<?php print path_to_theme(); ?>/css/device-wide.css" media="only all and (min-width: 1025px)" id="stylesheet-1280" />
  <?php print $scripts; ?>
  <script type="text/javascript"><?php /* Needed to avoid Flash of Unstyled Content in IE */ ?> </script>
  <script type="text/javascript" href="/<?php print path_to_theme(); ?>/js/responsiveimgs.js"></script>
  <meta name="viewport" content="initial-scale=1, maximum-scale=1" />
  
  <!--[if lt IE 9]>
   <script type="text/javascript" src="/sites/all/themes/basetheme_res/js/css-media-query-ie.js"></script>
  <![endif]-->
	      ...
	      <div id="main" class="column">
	        ...
	        <div id="content">
	          ...
	          <?php if (!empty($content_bottom)): ?>
	            <div id="content-bottom" class="section">
		      ...
		      <?php if (!empty($right_right)): ?>
		        <div id="sidebar-right-right" class="column sidebar">
		          <?php print $right; ?>
		        </div> <!-- /sidebar-right -->
		      <?php endif; ?>
