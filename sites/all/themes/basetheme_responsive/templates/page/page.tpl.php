...
<head>
  ...
  <?php print $styles; ?>
  <link rel="stylesheet" type="text/css" media="screen and (max-device-width: 480px)" href="/sites/all/themes/basetheme_res/css/device-480.css" />
  <script type="text/javascript" href="/sites/all/themes/basetheme_res/js/responsiveimgs.js"></script>
  <?php print $scripts; ?>
  <script type="text/javascript"><?php /* Needed to avoid Flash of Unstyled Content in IE */ ?> </script>
  <meta name="viewport" content="initial-scale=1, maximum-scale=1" />
</head>
<body id="base-fluid" class="<?php print $body_classes; ?>">
